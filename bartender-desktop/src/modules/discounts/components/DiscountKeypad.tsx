        ...
        <div className="grid grid-cols-5 gap-2">
          {descuentosRapidos.map((valorRapido) => (
            <button
              ...
              className="
                h-12 rounded-lg font-bold text-sm transition-all border flex items-center justify-center
      ...
      <div className="grid grid-cols-3 gap-2">
        {numerosTeclado.map((numero) => (
          <button
            ...
            className="h-16 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center text-2xl font-bold text-white transition-all active:scale-95 border border-white/10 touch-manipulation"
          >
            {numero}
          </button>
        ))}
        ...
        <button
          ...
          className="h-16 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center text-3xl font-bold text-white transition-all active:scale-95 border border-white/10 touch-manipulation pb-2"
        >
          .
        </button>
      </div>
          ...
          <div className="flex gap-2 flex-wrap">
            {valoresRecientes.map((valorReciente) => (
              <button
                ...
                className="px-3 py-1 bg-white/5 hover:bg-white/10 text-white/70 rounded-lg text-xs font-medium transition-all border border-white/10"
              >
                {valorReciente}%
              </button>
            ))}

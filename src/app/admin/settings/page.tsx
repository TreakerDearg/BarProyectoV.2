    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-400 mt-1">Gestión del módulo de settings.</p>
        </div>
      ...
      <div className="p-8 rounded-xl border border-white/5 bg-zinc-950/50 backdrop-blur-sm min-h-[400px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-zinc-500 max-w-sm mx-auto">
            El módulo de settings está siendo implementado con la API del backend.
          </p>
        </div>
      </div>
    </div>

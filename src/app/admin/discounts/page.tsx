...
export const metadata = {
  title: 'Discounts | Obsidian Admin',
};
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white">Discounts</h1>
          <p className="text-zinc-400 mt-1">Gestión del módulo de discounts.</p>
        </div>
      ...
      <div className="p-8 rounded-xl border border-white/5 bg-zinc-950/50 backdrop-blur-sm min-h-[400px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-zinc-500 max-w-sm mx-auto">
            El módulo de discounts está siendo implementado con la API del backend.
          </p>
        </div>
      </div>
    </div>

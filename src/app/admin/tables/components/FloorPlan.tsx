    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="flex items-center justify-between mb-6 px-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black text-grad-gold tracking-tight uppercase">
              Vista de Salón
            </h2>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] text-dim font-bold uppercase tracking-[0.2em]">
                Grid View · Central Ops
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative flex-1 glass-royale rounded-[2.5rem] overflow-hidden group/floor shadow-royale">
        ...
        {/* LEGEND */}
        <div className="absolute bottom-8 right-8 flex items-center gap-6 glass-royale px-6 py-3 rounded-full shadow-royale">
...
function LegendItem({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-[9px] font-black uppercase text-white/50 tracking-tighter">
        {label}
      </span>
